---
name: jl-documentation-template
description: "Provides the canonical documentation template and structure for feature and API documentation stored in docs/. Use when creating or validating documentation with jl-feature-documenter or jl-documenter."
---
...
documentation produced by `jl-feature-documenter` and
`jl-documenter`. It exists so the documentation template is loaded
...
- Use `jl-code-quality` when documenting code examples, to ensure
