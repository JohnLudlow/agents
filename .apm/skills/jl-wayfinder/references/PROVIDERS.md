...
<<<<<<<< HEAD:.apm/skills/jl-recon/references/PROVIDERS.md
- **Ticket type**: a label — `recon:research`, `recon:prototype`,
  `recon:quiz`, `recon:task`.
|||||||| dfdacc7:.apm/skills/johnludlow-wayfinder/references/PROVIDERS.md
- **Ticket type**: a label — `wayfinder:research`, `wayfinder:prototype`,
  `wayfinder:grilling`, `wayfinder:task`.
========
- **Ticket type**: a label — `wayfinder:research`, `wayfinder:prototype`,
  `wayfinder:quiz`, `wayfinder:task`.
>>>>>>>> 66f6931dd379d96e84ea12ef22289fc8c70d5729:.apm/skills/jl-wayfinder/references/PROVIDERS.md
