...
The jl-feature-reviewer is an adversarial quality gate. It actively looks
...
- Does documentation follow `jl-markdown-standards` source line
...
- `jl-code-quality` — use this repo-owned skill to assess code under
  review against SOLID, testability, and performance standards across C#,
  TypeScript, and C++
- `jl-markdown-standards` — use this repo-owned skill to assess
