...
## Description
Agent for documenting code and features. Produces well-formed markdown documentation in `/docs` folder based on templates and existing implementation.

## Temperature
0.2

## Purpose
The johnludlow-feature-documenter creates comprehensive, user-friendly documentation that explains features, APIs, and systems to other developers and users.
